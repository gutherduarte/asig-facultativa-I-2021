...
namespace AppVenta.Infraestructura.Datos.Contextos {
	public class VentaContexto : DbContext {
		...
		protected override void OnConfiguring(DbContextOptionsBuilder options) {
			options.UseSqlServer($"Server={SERVER},{PORT};Initial Catalog={DATABASE};Persist Security Info=False;User ID={USERNAME};Password={PASSWORD};MultipleActiveResultSets=False;Encrypt=True; Integrated Security={INTEGRATED_SECURITY};TrustServerCertificate={TRUST_SERVER_CERTIFICATE};Connection Timeout=30;");
		}
